...
def main():
    ...
    object_key = 'crawl_to_s3_file/population_data.json'  # S3 file name
    file_name = 'download_from_s3_file/population_data.json'  # local name
    ...
    conn = connect_to_db("social population")
    try:
